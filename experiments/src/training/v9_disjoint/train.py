...
sys.path.append(str(PROJECT_ROOT / "experiments" / "src" / "training" / "v9_disjoint"))
...
class MultiHeadSaProtV8(nn.Module):
    def __init__(self, emb_dim=1280, aux_dim_tm=9, aux_dim_ogt=8, proj_dim=64, hidden1=512, hidden2=256, dropout1=0.3, dropout2=0.2, use_residuals=True):
        super().__init__()
...
def main():
    ...
    save_dir = os.path.join(PROJECT_ROOT, "experiments/src/training/v9_disjoint/results")
