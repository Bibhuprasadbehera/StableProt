...
- **Real Wet-Lab Experimental Mutation Scatter & Histogram Plot**: [`experiments/results/real_mutation_benchmark_plot.png`](file:///home/bibhu/Documents/temstampto/experiments/results/real_mutation_benchmark_plot.png)

---

### 8.6 Real Wet-Lab Experimental Mutation $\Delta T_m$ Benchmark Results

*Evaluated directly across all **3,649 physical wet-lab experimental mutant entries** in FireProtDB ([`fireprotdb_results.csv`](file:///home/bibhu/Documents/temstampto/data/test_data/external/fireprotdb_results.csv)) comparing independent Wild-Type and Mutant StableProt predictions ($\Delta \hat{T}_m = \hat{T}_{m, \text{Mut}} - \hat{T}_{m, \text{WT}}$) against real experimental $\Delta T_{m, \text{exp}}$ readings:*

| Evaluation Metric | Value ($N=3,649$) | Biophysical Interpretation |
|:---|:---:|:---|
| **$\Delta T_m$ Mean Absolute Error (MAE)** | **5.05°C** | Average deviation from physical wet-lab unfolding shift |
| **$\Delta T_m$ Root Mean Squared Error (RMSE)** | **7.78°C** | Sensitivity to extreme experimental outlier shifts |
| **Pearson Correlation ($r$)** | **0.1933** | Linear correlation between predicted vs experimental $\Delta T_m$ |
| **Spearman Rank Correlation ($\rho$)** | **0.2114** | Monotonic rank ordering accuracy across mutation candidates |
| **Directional Classification Accuracy** | **56.8%** | Binary accuracy in predicting stabilizing ($\Delta T_m > 0$) vs destabilizing ($\Delta T_m \le 0$) mutations |
| **ROC-AUC Score** | **0.5854** | Discrimination capacity for identifying thermal stabilization variants |

**Artifact Locations**:
- Results Table: [`experiments/results/real_mutation_benchmark_results.csv`](file:///home/bibhu/Documents/temstampto/experiments/results/real_mutation_benchmark_results.csv)
- 4-Panel Diagnostic Figure: [`experiments/results/real_mutation_benchmark_plot.png`](file:///home/bibhu/Documents/temstampto/experiments/results/real_mutation_benchmark_plot.png)
- Analysis Document: [`experiments/results/real_mutation_benchmark_analysis.md`](file:///home/bibhu/Documents/temstampto/experiments/results/real_mutation_benchmark_analysis.md)
