...
def map_fireprot_to_uniprot_ids(fp_seqs, base_dir):
    ...
    sql_path = os.path.join(base_dir, "../../new_data/fireprotdb_dump_2025_09_22/01_fireprotdb_2025-09-20.sql")
    csv_path = os.path.join(base_dir, "../../new_data/fireprotdb_dump_2025_09_22/fireprotdb_csv_whole/fireprotdb_20251015-164116.csv")
